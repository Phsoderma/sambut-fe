...
export const WORKFLOW_STATES: Record<WorkflowState, StateConfig> = {
  ...
  DESTINATION: {
    ...
    allowedStaffIntents: ['TANYA_KELUHAN', 'KONFIRMASI'],
    nextState: 'WAITING_STAFF_QUESTION',
    previousState: 'INSURANCE',
  },
  WAITING_STAFF_QUESTION: {
    id: 'WAITING_STAFF_QUESTION',
    title: 'Menunggu Pertanyaan Petugas',
    questionText: 'Silakan tunggu sejenak, petugas loket sedang menyiapkan pertanyaan...',
    signDescription: 'Petugas sedang menentukan apakah ada pertanyaan tambahan.',
    allowedUserIntents: ['YA', 'TIDAK', 'UNKNOWN'],
    allowedStaffIntents: ['TANYA_KELUHAN', 'KONFIRMASI'],
    nextState: 'CONFIRM',
  ...
  CUSTOM_QUESTION: {
    ...
    questionText: 'Pertanyaan Tambahan dari Petugas Loket',
    signDescription: 'Jawab pertanyaan tambahan dari petugas melalui BISINDO atau ketikan teks.',
    allowedUserIntents: ['YA', 'TIDAK', 'SAKIT', 'TOLONG', 'UNKNOWN'],
    allowedStaffIntents: ['TANYA_KELUHAN', 'KONFIRMASI'],
    nextState: 'WAITING_STAFF_QUESTION',
    previousState: 'DESTINATION',
  },
